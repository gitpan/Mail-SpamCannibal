...
server with no outside access. Users are invited to write a FAQ or
...
=for html Copy the DNSBLserver/rc.dnsbls script to the appropriate startup directory and
...
self explainatory. Your comments and additions to this documment are welcomed.
...
the host startup scripts put a lines like this:
