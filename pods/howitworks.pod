...
and links, click the <a href="#top" onMouseOver="status='DOWNLOAD';return true;" onMouseOut="status='';return true;"
...
<ul>
<li><a href=dbtarpit.html>IPTables::IPv4::DBTarpit</a>, a database backed TCP/IP connection tarpit and IP
...
<p>
<li><a href=dnsbls.html>Mail::SpamCannibal::DNSBLserver</a>, a lightweight DNSBL server written
...
<ul>
<li>The <a href=dbtarpit.html>dbtarpit</a> daemon interfaces directly with  Linux iptables. All
...
halt for several hours or perhaps indefinetly. Tarpits maintained on our
firewall servers hold some threads for months.
<p>
More information on tarpits is available on the LaBrea and LaBrea::Tarpit
websites at:<br>
<blockquote>
